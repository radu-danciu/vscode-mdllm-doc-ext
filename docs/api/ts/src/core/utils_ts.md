...
Returns:
Value returned by `normalizeWhitespace`.
...
Returns:
Value returned by `normalizePosix`.
...
Returns:
Value returned by `replaceFinalDot`.
...
Returns:
Value returned by `encodeCommandUri`.
...
Returns:
Value returned by `truncateMarkdown`.
...
Returns:
Value returned by `viewColumnForMode`.
...
Returns:
Value returned by `positionAtStartOfRange`.
...
Returns:
Value returned by `joinWorkspacePath`.
...
Returns:
Value returned by `sourceRelativePathForDocument`.
