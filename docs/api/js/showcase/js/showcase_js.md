...
Details:
This class keeps the JavaScript sample intentionally minimal while still covering type and method hovers.
...
Details:
The extension treats exported object containers as documentable symbol groups for JavaScript modules.
